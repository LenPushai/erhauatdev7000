-- ERHA OPS - Create Admin User (ENUM Compatible)
...
-- Create admin user with proper ENUM values
INSERT INTO users (
...
SELECT id, username, email, user_role, user_status, safety_clearance, is_active 
