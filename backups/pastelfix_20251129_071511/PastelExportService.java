...
public class PastelExportService {
    ...
    private String generateQuoteCsv(Quote quote) {
        ...
        csv.append(getQuoteHeader()).append(NEWLINE);
        csv.append(getQuoteRow(quote)).append(NEWLINE);
        csv.append(String.format("\"Grand Total\",,,,,\"%s\",\"%s\",\"%s\",,", formatAmount(quote.getSubtotal()), formatAmount(quote.getTaxAmount()), formatAmount(quote.getTotalAmount()))).append(NEWLINE);
        return csv.toString();
    }
    ...
    private String getQuoteRow(Quote quote) {
        ...
        return String.format("\"%s\",\"%s\",\"%s\",\"%s\",\"%s\",\"%s\",\"%s\",\"%s\",\"%s\",\"%s\"",
                ...
                formatAmount(quote.getTaxAmount()), formatAmount(quote.getTotalAmount()), "", status);
    }
    ...
    private String mapStatusToSage(QuoteStatus status) {
        ...
        switch (status) {
            ...
            case PENDING_QUALITY_REVIEW: return "Pending";
            case PENDING_SAFETY_REVIEW: return "Pending";
            case PENDING_APPROVAL: return "Pending";
            case APPROVED: return "Approved";
            case SENT: return "Sent";
            case SENT_TO_CLIENT: return "Sent";
            case VIEWED: return "Viewed";
            case UNDER_NEGOTIATION: return "Negotiation";
            case ACCEPTED: return "Accepted";
            case REJECTED: return "Declined";
            case EXPIRED: return "Expired";
            case CANCELLED: return "Cancelled";
            case CONVERTED_TO_CONTRACT: return "Converted";
